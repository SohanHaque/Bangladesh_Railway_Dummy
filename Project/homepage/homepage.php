                    ...
                    <td>
                        <div class="content">
                            ...
                            <table>
                                ...
                                <br>
                                <a href="http://localhost/Project/Login$Reg/Traininformation.php" button type="submit" style="background-color: green; color: white; padding: 10px 20px; border: none; cursor: pointer;">Search Trains</button>
                                </a><br>
                            </form>
                        </div>
                    </td>
