...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql = "INSERT INTO myreg(newMobileNumber,nid,dob) VALUES ('$newMobileNumber','$nid', '$dob')";
    ...
    <div class="container">
        <center>
            ...
            <p style="color: rgb(59, 56, 56); font-family: Verdana, Geneva, Tahoma, sans-serif;">Enter the information below to verify and register
                ...
                <br>Details used during the SMS verification.</p><br><br><br>
        </center>
    </div>
    <div class="container2">
        <form>
            <label for="newMobileNumber">Mobile Number</label>
            <input type="text" id="newMobileNumber" placeholder="Enter your mobile number" required>
            ...
            <input type="password" id="pass2" placeholder="Enter your Password Again" required>
            ...
            <button type="submit" class="submit_data">Submit Data</button><br>
            <a href="http://localhost/Project/Loginpage.php" style="color: #4fb854;" align="center">Already Registered?</a><br>
        </form>
    </div><br><br><br><br>
