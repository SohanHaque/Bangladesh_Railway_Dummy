...
<body style=" background-image: url(animeTrain.gif); height: 100%; background-repeat: no-repeat; background-size: cover;" >
<div>
    <header>
    <div class="logo_box">
    <div>
    ...
    <div class="container">
        <div class="login-box">
            ...
            <form>
                ...
                <a href="http://localhost/Project/Registrationpage.php" style="color: #4fb854;" align="center">Register</a><br>
            </form>
        </div>
    </div>
    <div>
